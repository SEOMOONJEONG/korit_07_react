...
// updateItem  반환 : 갱신된 shoppingItem(서버 응답 형식에 따름)
...
/*
  Googld ID 토큰을 백엔드로 보낸 다음 검증하고, 앱의 JWT를 받아옵니다.
